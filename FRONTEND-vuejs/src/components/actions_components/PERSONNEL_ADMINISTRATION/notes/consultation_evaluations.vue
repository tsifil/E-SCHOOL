               ...
               >
                    ...
                    <template slot-scope="{data}">
                        <vs-tr :key="indextr" v-for="(tr,indextr) in data" >
                            ...
                            <vs-td id="vs_tbV">
                                <router-link class="btn btn-success btn-sm" :to="{name:'VoirNotesAdmin',params:{idTrimestre:data[indextr].idTrimestre,codemat:data[indextr].codemat}}">
                                  <i class="ti-eye"></i>
                                </router-link>
                            </vs-td>
                        </vs-tr>
                      ...
                      <!--table class="table table-bordered">
                        ...
                        <tbody>
                            <tr v-for="(mt) in matiereTrimestres" :key="mt.numMatricule">
                                <td>{{mt.nomMatiere}}</td>
                                <td>{{mt.libelle}}</td>
                                <td><router-link :to="{name:'VoirNotesAdmin',params:{idTrimestre:mt.idTrimestre,codemat:mt.codemat}}"><i class="ti-eye"></i></router-link></td>
                           </tr>
                        </tbody>
                      </table-->
                    </div>
...
export default {
   ...
   methods:{
        getMatiereTrimestre(){
            HTTP.get(`/professeur/matiere/trimestre/${this.idAs}`)
            .then((response)=>{
